    ...
    <div class="home-main">
        <Row :gutter="10">
            ...
            <Row :gutter="5">
                ...
                <infor-card id-name="user_created_count" :end-val="count.createUser" iconType="android-person-add" color="#2d8cf0" intro-text="所有用户"></infor-card>
                </Col>
                <Col :xs="24" :sm="12" :md="6" :style="{marginBottom: '10px'}">
                <infor-card id-name="visit_count" :end-val="count.visit" iconType="ios-eye" color="#64d572" :iconSize="50" intro-text="裝置類型"></infor-card>
                </Col>
                <Col :xs="24" :sm="12" :md="6" :style="{marginBottom: '10px'}">
                <infor-card id-name="collection_count" :end-val="count.collection" iconType="upload" color="#ffd572" intro-text="裝置數量"></infor-card>
                </Col>
                <Col :xs="24" :sm="12" :md="6" :style="{marginBottom: '10px'}">
...
export default {
  ...
  data() {
    return {
      ...
      count: {
        createUser: this.$store.state.user.users.length,
        visit: this.$store.state.device.map.length,
        collection: this.$store.state.device.list.length,
        transfer: 39503498
      },
      cityData: cityData,
